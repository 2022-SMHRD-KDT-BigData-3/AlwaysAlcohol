				...
				<header style="text-align: center;">
					...
					<p style="margin-bottom: 5px;">회원님의 취향과 선호도를 분석하여 저희가
                        ...
                        <article class="style1">
                           ...
                           <a href="wineKind.jsp?data=레드와인&cnt=0">
                              <h2>레드 와인</h2>
                              <!-- <div class="content">
                                 <p>레드 와인 설명글</p>
                              </div> -->
                        ...
                        <article class="style2">
                           ...
                           <a href="wineKind.jsp?data=화이트와인&cnt=0" >
                              <h2>화이트 와인</h2>
                              <!-- <div class="content">
                                 <p>화이트 와인 설명글</p>
                              </div> -->
                        ...
                        <article class="style3">
                           ...
                           <a href="wineKind.jsp?data=스파클링와인&cnt=0">
                              <h2>스파클링 와인</h2>
                              <!-- <div class="content">
                                 <p>스파클링 와인 설명글</p>
                              </div> -->
                        ...
                        <article class="style4">
                           ...
                           <a href="wineKind.jsp?data=로제와인&cnt=0">
                              <h2>로제 와인</h2>
                              <!-- <div class="content">
                                 <p>로제 와인 설명글</p>
                              </div> -->
                        ...
                        <article class="style5">
                           ...
                           <a href="wineKind.jsp?data=주정강화와인&cnt=0">
                              <h2>주정강화 와인</h2>
                              <!-- <div class="content">
                                 <p>주정강화 와인 설명글</p>
                              </div> -->
                        ...
                        <article class="style6">
                           ...
                           <a href="wineKind.jsp?data=고도주와인&cnt=0">
                              <h2>고도주 와인</h2>
                              <!-- <div class="content">
                                 <p>고도주  와인 설명글</p>
                              </div> -->
                        ...
                        <article class="style2">
                           ...
                           <a href="wineKind.jsp?data=기타와인&cnt=0">
                              <h2>기타 와인</h2>
